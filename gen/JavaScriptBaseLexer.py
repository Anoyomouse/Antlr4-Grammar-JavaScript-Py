...
class JavaScriptBaseLexer(Lexer):
    ...
    def ProcessOpenBrace(self):
        self.useStrictCurrent = self.scopeStrictModes and (True if self.scopeStrictModes[-1] else self.useStrictDefault)
        self.scopeStrictModes.append(self.useStrictCurrent)

    def ProcessCloseBrace(self):
        self.useStrictCurrent = self.scopeStrictModes and (True if self.scopeStrictModes.pop(-1) else self.useStrictDefault)
